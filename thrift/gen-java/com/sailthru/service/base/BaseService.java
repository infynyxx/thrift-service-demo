 ...
 *  @generated
 */
package com.sailthru.service.base;
...
public class BaseService {
  ...
  public interface Iface {
     ...
     */
    public ServiceStatus getStaus() throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void getStaus(org.apache.thrift.async.AsyncMethodCallback<AsyncClient.getStaus_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    {
      send_getStaus();
      return recv_getStaus();
    }

    public void send_getStaus() throws org.apache.thrift.TException
    {
      getStaus_args args = new getStaus_args();
      sendBase("getStaus", args);
    }

    public ServiceStatus recv_getStaus() throws org.apache.thrift.TException
    {
      getStaus_result result = new getStaus_result();
      receiveBase(result, "getStaus");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "getStaus failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getStaus(org.apache.thrift.async.AsyncMethodCallback<getStaus_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getStaus_call method_call = new getStaus_call(resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getStaus_call extends org.apache.thrift.async.TAsyncMethodCall {
      public getStaus_call(org.apache.thrift.async.AsyncMethodCallback<getStaus_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("getStaus", org.apache.thrift.protocol.TMessageType.CALL, 0));
        getStaus_args args = new getStaus_args();
        args.write(prot);
        prot.writeMessageEnd();
      }
      ...
      public ServiceStatus getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_getStaus();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("getStaus", new getStaus());
    ...
    private static class getStaus<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getStaus_args> {
      public getStaus() {
        super("getStaus");
      }

      protected getStaus_args getEmptyArgsInstance() {
        return new getStaus_args();
      }

      protected getStaus_result getResult(I iface, getStaus_args args) throws org.apache.thrift.TException {
        getStaus_result result = new getStaus_result();
        result.success = iface.getStaus();
        return result;
      }
    }
...
;
  ...
  public static class getStaus_args implements org.apache.thrift.TBase<getStaus_args, getStaus_args._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getStaus_args");


    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getStaus_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getStaus_argsTupleSchemeFactory());
    }
...
;
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getStaus_args.class, metaDataMap);
    }

    public getStaus_args() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public getStaus_args(getStaus_args other) {
    }

    public getStaus_args deepCopy() {
      return new getStaus_args(this);
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getStaus_args)
        return this.equals((getStaus_args)that);
      return false;
    }

    public boolean equals(getStaus_args that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getStaus_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getStaus_args typedOther = (getStaus_args)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getStaus_args(");
      boolean first = true;
    ...
    private static class getStaus_argsStandardSchemeFactory implements SchemeFactory {
      public getStaus_argsStandardScheme getScheme() {
        return new getStaus_argsStandardScheme();
      }
    }

    private static class getStaus_argsStandardScheme extends StandardScheme<getStaus_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getStaus_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getStaus_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getStaus_argsTupleSchemeFactory implements SchemeFactory {
      public getStaus_argsTupleScheme getScheme() {
        return new getStaus_argsTupleScheme();
      }
    }

    private static class getStaus_argsTupleScheme extends TupleScheme<getStaus_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getStaus_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
      }

      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getStaus_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
      }
    }
  ...
  public static class getStaus_result implements org.apache.thrift.TBase<getStaus_result, getStaus_result._Fields>, java.io.Serializable, Cloneable   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("getStaus_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.I32, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new getStaus_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new getStaus_resultTupleSchemeFactory());
    }
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(getStaus_result.class, metaDataMap);
    }

    public getStaus_result() {
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public getStaus_result(getStaus_result other) {
      if (other.isSetSuccess()) {
        this.success = other.success;
      }
    }

    public getStaus_result deepCopy() {
      return new getStaus_result(this);
    }
     ...
     * @see ServiceStatus
     */
    public getStaus_result setSuccess(ServiceStatus success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof getStaus_result)
        return this.equals((getStaus_result)that);
      return false;
    }

    public boolean equals(getStaus_result that) {
      if (that == null)
        return false;
    ...
    public int compareTo(getStaus_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }

      int lastComparison = 0;
      getStaus_result typedOther = (getStaus_result)other;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("getStaus_result(");
      boolean first = true;
    ...
    private static class getStaus_resultStandardSchemeFactory implements SchemeFactory {
      public getStaus_resultStandardScheme getScheme() {
        return new getStaus_resultStandardScheme();
      }
    }

    private static class getStaus_resultStandardScheme extends StandardScheme<getStaus_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, getStaus_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getStaus_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class getStaus_resultTupleSchemeFactory implements SchemeFactory {
      public getStaus_resultTupleScheme getScheme() {
        return new getStaus_resultTupleScheme();
      }
    }

    private static class getStaus_resultTupleScheme extends TupleScheme<getStaus_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, getStaus_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, getStaus_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = ServiceStatus.findByValue(iprot.readI32());
